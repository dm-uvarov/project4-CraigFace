...
Post.create(name: "cutting board", description: "A kitchen utensil used as a protective surface on which to cut or slice things.", category: "kitchen", image_url: cb, user_id: kevin.id, price: 50,likes: 0)
Post.create(name: "kitchen knife", description: "Used for cutting meat, dicing vegetables, disjointing some cuts, slicing herbs, and chopping nuts, but there are a number of different varieties for separate purposes, including carving, slicing and bread knives for specific ingredients.", category: "kitchen", image_url: knife, user_id: kevin.id, price: 25,likes: 0)
Post.create(name: "silverware", description: "Dishes, containers, or cutlery made of or coated with silver.", category: "kitchen", image_url: sw, user_id: kevin.id, price: 25,likes: 0)